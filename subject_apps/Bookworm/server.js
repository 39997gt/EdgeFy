...
app.get('/api/ladywiththepetdog', function(req, res){
  fs.readFile('/home/kijin/projects/CWV/cost_ftn/theladywiththepetdog.txt', 'utf-8', function(err, data){
...
app.get('/api/thecask', function(req, res){
//  fs.readFile('./client/data/thecaskofamontillado.txt', 'utf-8', function(err, data){
    fs.readFile('/home/kijin/projects/CWV/cost_ftn/thecask.txt', 'utf-8', function(err, data){
//	console.log("test");
    var bookData = {
      text: data.replace("�", "").toString(),
...
app.get('/api/wallpaper', function(req, res){
 ...
 fs.readFile('/home/kijin/projects/CWV/cost_ftn/wallpaper.txt', 'utf-8', function(err, data){
    var bookData = {
      text: data.replace("�", "").toString(),
