...
#CallExpression:subject_apps/ionic2-realty-rest/server/norm_property-service.js:680/home/kijin/projects/JS-RCI
...
fp.fact(postdom(BitVecVal(1118,lineNum),BitVecVal(1117,lineNum)))
fp.fact(postdom(BitVecVal(1119,lineNum),BitVecVal(1117,lineNum)))
fp.fact(postdom(BitVecVal(1120,lineNum),BitVecVal(1117,lineNum)))
...
fp.fact(postdom(BitVecVal(1129,lineNum),BitVecVal(1128,lineNum)))
...
fp.fact(postdom(BitVecVal(1140,lineNum),BitVecVal(1139,lineNum)))
...
fp.fact(postdom(BitVecVal(1174,lineNum),BitVecVal(1173,lineNum)))
fp.fact(postdom(BitVecVal(1175,lineNum),BitVecVal(1173,lineNum)))
fp.fact(postdom(BitVecVal(1176,lineNum),BitVecVal(1173,lineNum)))
#VariableDecl: var i = 0
code[1174]="var i = 0"
...
fp.fact(postdom(BitVecVal(1185,lineNum),BitVecVal(1184,lineNum)))
...
fp.fact(postdom(BitVecVal(1024,lineNum),BitVecVal(1026,lineNum)))



fp.fact(postdom(BitVecVal(1038,lineNum),BitVecVal(1042,lineNum)))

fp.fact(postdom(BitVecVal(1042,lineNum),BitVecVal(1046,lineNum)))

fp.fact(postdom(BitVecVal(1046,lineNum),BitVecVal(1052,lineNum)))

fp.fact(postdom(BitVecVal(1052,lineNum),BitVecVal(1055,lineNum)))

fp.fact(postdom(BitVecVal(1055,lineNum),BitVecVal(1057,lineNum)))



fp.fact(postdom(BitVecVal(1066,lineNum),BitVecVal(1070,lineNum)))

fp.fact(postdom(BitVecVal(1070,lineNum),BitVecVal(1074,lineNum)))

fp.fact(postdom(BitVecVal(1074,lineNum),BitVecVal(1080,lineNum)))

fp.fact(postdom(BitVecVal(1080,lineNum),BitVecVal(1083,lineNum)))



fp.fact(postdom(BitVecVal(1094,lineNum),BitVecVal(1096,lineNum)))



fp.fact(postdom(BitVecVal(1107,lineNum),BitVecVal(1111,lineNum)))



fp.fact(postdom(BitVecVal(1117,lineNum),BitVecVal(1128,lineNum)))

fp.fact(postdom(BitVecVal(1128,lineNum),BitVecVal(1133,lineNum)))

fp.fact(postdom(BitVecVal(1117,lineNum),BitVecVal(1139,lineNum)))

fp.fact(postdom(BitVecVal(1139,lineNum),BitVecVal(1141,lineNum)))

fp.fact(postdom(BitVecVal(1139,lineNum),BitVecVal(1143,lineNum)))

fp.fact(postdom(BitVecVal(1143,lineNum),BitVecVal(1148,lineNum)))

fp.fact(postdom(BitVecVal(1148,lineNum),BitVecVal(1154,lineNum)))



fp.fact(postdom(BitVecVal(1165,lineNum),BitVecVal(1169,lineNum)))



fp.fact(postdom(BitVecVal(1173,lineNum),BitVecVal(1184,lineNum)))

fp.fact(postdom(BitVecVal(1184,lineNum),BitVecVal(1187,lineNum)))

fp.fact(postdom(BitVecVal(1187,lineNum),BitVecVal(1189,lineNum)))

fp.fact(postdom(BitVecVal(1189,lineNum),BitVecVal(1195,lineNum)))

fp.fact(postdom(BitVecVal(1173,lineNum),BitVecVal(1205,lineNum)))

fp.fact(postdom(BitVecVal(1205,lineNum),BitVecVal(1207,lineNum)))



fp.fact(postdom(BitVecVal(1218,lineNum),BitVecVal(1222,lineNum)))

fp.fact(postdom(BitVecVal(1222,lineNum),BitVecVal(1230,lineNum)))

fp.fact(postdom(BitVecVal(1230,lineNum),BitVecVal(1233,lineNum)))

fp.fact(postdom(BitVecVal(1233,lineNum),BitVecVal(1241,lineNum)))

fp.fact(postdom(BitVecVal(1241,lineNum),BitVecVal(1244,lineNum)))
...
hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:161:183"]={"bin":1024, "name":"var tmpv0 = PROPERTIES;"};
...
hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:304:323"]={"bin":1046, "name":"var temp5 = idd2-1;"};
...
hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:328:358"]={"bin":1052, "name":"var temp6 = PROPERTIES[temp5];"};
...
fp.fact(stmtdep(BitVecVal(hashVar["dVXRLg.js:21:11646"]["bin"],lineNum),BitVecVal(hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:49:100"]["bin"],lineNum)))
boundToExtractFunction = 1272;


fp.fact(RWlogs(BitVecVal(hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:161:183"]["bin"],lineNum),BitVecVal(9114157,val)))
fp.fact(RWlog(BitVecVal(hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:187:192"]["bin"],var),BitVecVal(1717943,val)))

fp.fact(RWlogs(BitVecVal(hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:301:321"]["bin"],lineNum),BitVecVal(9114158,val)))
fp.fact(RWlog(BitVecVal(hashVar["subject_apps/ionic2-realty-rest/server/norm_property-service.js:354:359"]["bin"],var),BitVecVal(1717948,val)))

crdt_rewrite={}
crdt_rewrite["subject_apps/ionic2-realty-rest/server/norm_property-service.js"]={"rewrite":"_states.PROPERTIES","locs":["340:350","173:183"]}



subjects =[1,2]
sids =[9114157, 9114158]

sids_unmar =[9114158,9114157]
sids_mar =[1717948,1717943]
    ...
    if crdt_rewrite.has_key(_file):
        for loc in crdt_rewrite[_file]['locs']:
            ...
            if _start <= _s and _end >=_e:
                crdttxt=beforecloudjs[_start:_s]+crdt_rewrite[_file]['rewrite']+beforecloudjs[_e:_end]
                tree = parser.parse(crdttxt)
                for node in nodevisitor.visit(tree):
                    if isinstance(node, ast.VarStatement):
                        #print "####", node.to_ecma()
                        _last_node = node.to_ecma()
                        for prop in node:
                            if isinstance(prop, ast.VarDecl):
                         #       print "VarDecl", prop.to_ecma()
                                _last_decl = prop.to_ecma()
                                _last_iden = prop.identifier.value

    crdttxt=crdttxt.replace(_last_node,_last_decl);
    beforecloudjs = beforecloudjs[0:_start]+("\n    var "+_last_iden+";\n")+template1+crdttxt+template2+beforecloudjs[_end:len(beforecloudjs)-1]
    print colored("Edge-Refactor transforms Original Code `"+_file+"` into:\n..."+("\n    var "+_last_iden+";\n")+template1+crdttxt+template2+"...", "yellow")
...
cloud_parts={}
cloud_parts['transformed_cloud']=beforecloudjs
cloud_parts['snapshot']=extracted_parts['snapshot']
# print cloud_parts
#f = open("results/snapshots.json", "w")
#f.write(json_object)
json_object = json.dumps(extracted_parts, indent = 1)
f = open("results/edge_data.json", "w")
f.write(json_object)

json_object = json.dumps(cloud_parts, indent = 1)
f = open("results/cloud_data.json", "w")
f.write(json_object)
print colored("//See edge_data.json and cloud_data.json in results/\n", 'green')